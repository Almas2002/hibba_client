...
var RegionService = /** @class */ (function () {
    ...
    RegionService.prototype.createRegion = function (dto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.regionRepository.save({ value: dto.value })];
    ...
    RegionService.prototype.getRegions = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.regionRepository.find()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    RegionService.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.regionRepository.findOne(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
