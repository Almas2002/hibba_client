...
var MessageService = /** @class */ (function () {
    function MessageService(messageRepository, roomService, profileService) {
    ...
    MessageService.prototype.createMessage = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.roomService.getRoom(message.roomId)];
                    case 1:
                        room = _a.sent();
                        return [4 /*yield*/, this.messageRepository.save(__assign(__assign({}, message), { user: { id: message.userId }, room: { id: message.roomId } }))];
                    case 2: 
    ...
    MessageService.prototype.getAllMessage = function (id, pagination, newMessages) {
        return __awaiter(this, void 0, void 0, function () {
